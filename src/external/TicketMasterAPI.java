...
public class TicketMasterAPI implements ExternalAPI {
	 ...
	 */
	@Override
	public List<Item> search(double lat, double lon, String term) {		String url = "http://" + API_HOST + SEARCH_PATH;
	// Convert geo location to geo hash with a precision of 4 (+- 20km)
	String geohash = GeoHash.encodeGeohash(lat, lon, 4);		if (term == null) {
			term = DEFAULT_TERM;
		}
